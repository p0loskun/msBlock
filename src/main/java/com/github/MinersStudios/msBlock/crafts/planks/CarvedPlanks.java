...
public class CarvedPlanks {
	...
	public static ShapedRecipe craftCarvedAcaciaPlanks() {
		...
		ShapedRecipe shapedRecipe = new ShapedRecipe(new NamespacedKey(Main.getInstance(), customBlockMaterial.name()), customBlockMaterial.getItemStack())
				.shape("S", "S")
				.setIngredient('S', Material.ACACIA_SLAB);
		shapedRecipe.setGroup(Main.getPluginNameInLowerCase() + ":carved_planks");
		return shapedRecipe;
	}

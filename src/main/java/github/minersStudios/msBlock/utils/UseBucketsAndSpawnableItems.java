...
public class UseBucketsAndSpawnableItems {
	...
	private void useEmptyBucket() {
		if (this.block.getType() == Material.LAVA) {
			coreProtectAPI.logRemoval(this.player.getName(), this.block.getLocation(), Material.LAVA, this.block.getBlockData());
			...
			coreProtectAPI.logRemoval(player.getName(), this.block.getLocation(), Material.WATER, this.block.getBlockData());
	...
	private void setWater() {
		...
		coreProtectAPI.logPlacement(player.getName(), this.block.getLocation(), Material.WATER, this.block.getBlockData());
		setBucketIfSurvival();
	}
}